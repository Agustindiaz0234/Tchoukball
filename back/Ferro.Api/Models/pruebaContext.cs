...
//                optionsBuilder.UseMySql("server=localhost;port=3306;database=prueba;uid=root;password=Agustindiaz45.", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.34-mysql"));
            }
        }
